...
Project: IUP ITB Preparation Platform (RapsProject)
...
2. Generate a `supabase/seed.sql` or `lib/mockData.ts` populated with realistic dummy data for IUP ITB (Math & Physics in English), ensuring relations match this new schema.